    ...
    while True:
        ...
        if need_detect:
            ...
            if M is not None:
                ...
                squares, bbox_warp, centers_warp, _ = extract_squares_from_warp(img_warp, best_x, best_y, 0.12)
        ...
        if centers_img_last is not None and labels_last is not None:
            for r in range(8):
                for c in range(8):
                    ...
                    # hogy fekete/fehér is látszódjon: írjunk köré kontúrt
